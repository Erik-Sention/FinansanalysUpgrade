    ...
    try:
        ...
        test_data = {
            "meta": {
                ...
                "description": f"Excel import från {len(df)} rader",
                "year": 2024,  # Anta 2024 för nu
                "companies_count": len(df[company_col].unique()) if company_col else 0,
        ...
        # 1. Skapa företag
        for i, company_name in enumerate(df[company_col].unique()):
        ...
        # 4. Skapa värden från månadskolumner
        value_counter = 1
